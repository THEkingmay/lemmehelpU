...
function deleted(){
    tasksStore.deleted(currentindex.value)
    console.log("Delete index :",currentindex.value)
    timealert(2)
}
...
<template>
    ...
    <div class=" flex flex-col p-4">
        <div class="mb-2 border-b" v-for="(task, index) in tasks" :key="index">
            <div class="flex flex-col items-start md:grid grid-cols-2">
                <div class="p-3">
                    <div class="flex items-center">
                        ...
                        <button class="ml-3 btn btn-md btn-ghost" @click="more[index]=!more[index]">
                ...
                <div class="flex justify-end items-center h-full">
                    ...
                    <button class="btn btn-ghost" @click="clickdelete=true;currentindex=index;console.log(currentindex)" >
